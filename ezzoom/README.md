...
<p align="center">
  ...
  <h3 align="center">ezzoom.us (formerly Calendso)</h3>

  <p align="center">
    The open-source Calendly alternative.
    <br />
    <a href="https://ezzoom.us"><strong>Learn more »</strong></a>
    <br />
    <br />
    <a href="https://ezzoom.us/slack">Slack</a>
    ·
    <a href="https://ezzoom.us">Website</a>
    ·
...
<p align="center">
   <a href="https://ezzoom.us/slack"><img src="https://img.shields.io/badge/Slack-calendso.slack.com-%234A154B" alt="Join ezzoom.us Slack"></a>
  ...
  <a href="https://ezzoom.us/pricing"><img src="https://img.shields.io/badge/Pricing-%2412%2Fmonth-brightgreen" alt="Pricing"></a>
...
That's where ezzoom.us comes in. Self-hosted or hosted by us. White-label by design. API-driven and ready to be deployed on your own domain. Full control of your events and data.
...
<a href="https://www.producthunt.com/posts/calendso?utm_source=badge-top-post-badge&utm_medium=badge&utm_souce=badge-calendso" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/top-post-badge.svg?post_id=291910&theme=light&period=monthly" alt="ezzoom.us - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a> <a href="https://www.producthunt.com/posts/calendso?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-calendso" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=291910&theme=light" alt="ezzoom.us - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a> <a href="https://www.producthunt.com/stories/how-this-open-source-calendly-alternative-rocketed-to-product-of-the-day" target="_blank"><img src="https://ezzoom.us/maker-grant.svg" alt="ezzoom.us - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a>
...
4. Configure environment variables in the .env file. Replace `<user>`, `<pass>`, `<db-host>`, `<db-port>` with their applicable values
   ...
   7. In `Settings`, copy your URI to your ezzoom.us .env file and replace the `postgresql://<user>:<pass>@<db-host>:<db-port>` with it.
...
The Docker configuration for Cal is an effort powered by people within the community. ezzoom.us, Inc. does not provide official support for Docker, but we will accept fixes and documentation. Use at your own risk.
...
9. Under Authorized redirect URI's, select Add URI and then add the URI `<ezzoom.us URL>/api/integrations/googlecalendar/callback` replacing ezzoom.us URL with the URI at which your application runs.
...
4. Set the **Web** redirect URI to `<ezzoom.us URL>/api/integrations/office365calendar/callback` replacing ezzoom.us URL with the URI at which your application runs.
...
9. Set the Redirect URL for OAuth `<ezzoom.us URL>/api/integrations/zoomvideo/callback` replacing ezzoom.us URL with the URI at which your application runs.
...
12. Click "Done".
13. You're good to go. Now you can easily add your Zoom integration in the ezzoom.us settings.
...
Special thanks to these amazing projects which help power ezzoom.us:

[<img src="https://ezzoom.us/powered-by-vercel.svg">](https://vercel.com/?utm_source=calend-so&utm_campaign=oss)
